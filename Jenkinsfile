...
pipeline {
	...
	stages {
        ...
        script {
          ...
          changeRequestId = snDevOpsGetChangeNumber(changeDetails: """{"build_number":"${env.BUILD_NUMBER}","pipeline_name":""rama folder/child-1/child-2/fMultibranch-1234"","stage_name":"Deploy", "branchName":"main"}""")
